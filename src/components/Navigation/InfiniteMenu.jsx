...
class InfiniteGridMenu {
  ...
  #initTexture() {
    ...
    // Fill with placeholder color immediately
    ...
    this.items.forEach((item, i) => {
      ...
      gradient.addColorStop(0, '#D3FD50');
      gradient.addColorStop(1, '#88dd00');
  ...
  return (
    <div className="relative w-full h-full bg-black">
      ...
      {activeItem && (
        ...
        `}
          >
            <p className="select-none relative text-black top-[2px] text-[30px]">&#x2197;</p>
          </div>
        </>
      )}
    </div>
